...
//JAKE ENC BUTTON
#define buttonPin A1        // digital input pin

//NOAH ENC BUTTON
//#define buttonPin A0        // digital input pin
...
int holdTime = 1500;        // ms hold period: how long to wait for press+hold event - orig 2000
